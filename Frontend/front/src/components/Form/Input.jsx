...
export const Input = ({ registro, tipo, name, placeholder, errors, icon }) => {
  return (
    <>
      <div className="flex">
        <div className="w-10 z-10 pl-1 text-center text-acent_yellow pointer-events-none flex items-center justify-center">
          {icon}
        </div>
        <input
          {...registro}
      ...
      {errors && <div className="text-red-600">{errors.message}</div>}{" "}
