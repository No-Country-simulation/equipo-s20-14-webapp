...
const VistaTransporte = () =>{
  ...
  const guardarTransporte = async () => {
    try {
      const response = await axios.post("/operaciones/confirmar/{operacionId}", transporte);
      ...
      <Container maxWidth="sm">
        <Paper elevation={3} style={{ padding: "20px", marginTop: "20px" }}>
          ...
          <Typography variant="h5" gutterBottom>
            {editIndex !== null ? "Editar Gasto" : "Registrar Gasto de Transporte"}
          </Typography>
        ...
        {transporte.map((transporte, index) => (
          ...
          >
            <ListItemText
              ...
              secondary={`Fecha: ${transporte.fecha} | Monto: $${transporte.monto.toFixed(2)}`}
            />
          </ListItem>
